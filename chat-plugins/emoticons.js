		...
		try {
			switch (toId(parts[0])) {
				...
				case 'list':
					...
					var output = "<b>There's a total of " + Object.keys(emotes).length + " emoticons added with this command:</b><br />";
					for (var e in emotes) {
						output += e + "<br />";
					}
				...
				case 'help':
                    ...
                    "/emote modchat, set, [rank symbol / disable] - Sets moderated chat for chat emoticons in the respected room to the respected rank. Requires @, #, &, ~.<br />" +
					"/emote modchat, disable - Disables moderated chat for chat emoticons (enabled by default.) Requires @, #, &, ~.<br />" +
                    ...
                    "<a href=\"https://gist.github.com/jd4564/ef66ecc47c58b3bb06ec\">Emoticon Plugin by: jd & Panpawn</a>"
                    );
					break;
