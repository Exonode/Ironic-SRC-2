...
exports.commands = {
	...
	roomowner: function (target, room, user) {
		...
		room.auth[userid] = '#';
		this.addModCommand("" + name + " was appointed Room Lord by " + user.name + ".");
		if (targetUser) {
			targetUser.popup("You were appointed Room Lord by " + user.name + " in " + room.id + ".");
